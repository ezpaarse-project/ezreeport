...
* **report:** fixed colorMap not beign updated
* **report:** fixed issue with sort and bars

### Features

* **report:** more precisions if failed shards
* **report:** added default values when handling dates
