...
export const createTaskPresetsReadStream = (ezr: EZR) =>
  ezr.createDataReadStream<TaskPresetListItem, TaskPreset>({
    type: 'tasks presets',
    urls: {
      list: '/task-presets',
...
export const createTaskPresetsWriteStream = (ezr: EZR) =>
