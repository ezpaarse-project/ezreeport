...
const template = createTemplateHelperFrom({
  ...
  body: {
    ...
    filters: [
      ...
      {
        name: 'filter-4',
        raw: { range: { status: { lt: 299, gte: 200 } } },
        isNot: false,
      },
      {
            ...
            params: {
              labels: [
                { text: 'Total des accès', format: { type: 'number' } },
                {
                  text: 'Etablissements',
                  format: { type: 'number' },
                  aggregation: { type: 'cardinality', field: 'istex-id' },
                },
                {
                  text: 'Période du',
                  format: { type: 'date' },
                ...
                },
                {
                  ...
                  format: { type: 'number' },
                  aggregation: { type: 'cardinality', field: 'owner' },
                },
              ],
            },
            filters: [],
        ...
        figures: [
          {
            ...
            params: {
              color: {
                ...
                aggregation: { type: 'terms', field: 'owner' },
              },
              label: { aggregation: { type: 'terms', field: 'auth' } },
              ...
              columns: [
                {
                  header: 'host = ip',
                  metric: false,
                  aggregation: { type: 'terms', field: 'host' },
                },
                {
                  header: 'total des accès',
                  metric: true,
        ...
        figures: [
          {
            ...
            params: {
              label: {
                legend: null,
                aggregation: { type: 'terms', field: 'sid' },
              },
              title: 'sid',
              value: {},
              dataLabel: { format: 'percent', showLabel: true },
        ...
        figures: [
          {
            ...
            params: {
              label: {
                legend: null,
                aggregation: { type: 'terms', field: 'publisher_name' },
              },
