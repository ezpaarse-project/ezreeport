...
// import {
//   elasticCheckIndex, elasticCount, elasticSearch
// } from '../lib/elastic';
...
//   filters?: ElasticTypes.QueryDslQueryContainer;
// }
...
//         const { buckets, after_key } = aggregations.consult_by_date as AggregationResult<{
//           doc_count: number;
//           key: { consult_by_date: number; consult_by_portal: string };
//         }>;
...
//     // Consultations par type
//     async (): Promise<[Figure<'arc'>, Figure<'table'>]> => {
//       const data = await createElasticParams(
//         period,
//         {
//           index,
//           user,
...
//       const {
//         buckets: data,
//       } = aggregations.consult_by_platform;
