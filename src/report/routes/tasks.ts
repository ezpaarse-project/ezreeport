...
const router = CustomRouter('tasks')
   ...
   */
  .createSecuredRoute('GET /', Roles.READ, checkInstitution, async (req, res) => {
    try {
   ...
   * Parameter `institution` is only accessible to Roles.SUPER_USER (ignored otherwise)
   */
  .createSecuredRoute('POST /', Roles.READ_WRITE, checkInstitution, async (req, res) => {
    try {
   ...
   * Parameter `institution` is only accessible to Roles.SUPER_USER (ignored otherwise)
   */
  .createSecuredRoute('GET /:task', Roles.READ, checkInstitution, async (req, res) => {
    try {
   ...
   * Parameter `institution` is only accessible to Roles.SUPER_USER (ignored otherwise)
   */
  .createSecuredRoute('PUT /:task', Roles.READ_WRITE, checkInstitution, async (req, res) => {
    try {
      const { task: id } = req.params;
   ...
   * Parameter `institution` is only accessible to Roles.SUPER_USER (ignored otherwise)
   */
  .createSecuredRoute('DELETE /:task', Roles.READ_WRITE, checkInstitution, async (req, res) => {
    try {
      const { task: id } = req.params;
   ...
   * Parameter `institution` is only accessible to Roles.SUPER_USER (ignored otherwise)
   */
  .createSecuredRoute('PUT /:task/enable', Roles.READ_WRITE, checkInstitution, async (req, res) => {
    try {
      const { task: id } = req.params;
   ...
   * Parameter `institution` is only accessible to Roles.SUPER_USER (ignored otherwise)
   */
  .createSecuredRoute('PUT /:task/disable', Roles.READ_WRITE, checkInstitution, async (req, res) => {
    try {
      const { task: id } = req.params;
   ...
   */
  .createSecuredRoute('POST /:task/run', Roles.READ_WRITE, checkInstitution, async (req, res) => {
    try {
      const { task: id } = req.params;
   ...
   */
  .createRoute('PUT /:task/unsubscribe', async (req, res) => {
    try {
      const { task: id } = req.params;
      const data = req.body;
